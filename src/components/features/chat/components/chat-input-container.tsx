  ...
  return (
    <>
      <div
        ...
        className={cn(
          "chat-input-reference relative box-border flex w-full flex-col items-start justify-center overflow-hidden rounded-[20px] border border-white/[0.07] bg-[#1f1f1f] p-[14px_14px_10px] shadow-[0_16px_40px_-18px_rgba(0,0,0,0.7)]",
